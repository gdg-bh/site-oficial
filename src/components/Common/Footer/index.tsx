...
export function Footer() {
    const socialIcons = [
        ...
        { icon: whatsappIcon, alt: 'WhatsApp', href: 'https://chat.whatsapp.com/KTJwo0KIgQGJj3d2iU4viC' },
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                    <div className="space-y-6">
                        ...
                        <p className="text-[#6A7181] text-lg leading-relaxed max-w-md">
                            Desenvolvedores apaixonados e construtores de comunidades dedicados a promover o crescimento e o compartilhamento de conhecimento
                        </p>
                            ...
                            {socialIcons.map((social, index) => (
                                ...
                                >
                                    <img 
                                        ...
                                        alt={social.alt} 
                                        className={`${
                                            social.alt === 'Sympla' ? 'w-7 h-7' : 
                                            social.alt === 'WhatsApp' ? 'w-6 h-6' : 
                                            social.alt === 'Facebook' ? 'w-6 h-6' : 
                                            social.alt === 'Twitter' ? 'w-5 h-5' : 
                                            'w-7 h-7'
                                        }`}
                                    />
                                </a>
