        ...
        <>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto mb-16">
                        <div className="bg-white rounded-2xl shadow-md p-8 hover:shadow-lg transition-shadow duration-300 flex flex-col items-center">
                            ...
                            <h3 className="text-4xl font-semibold text-google-blue mb-2">410</h3>
                    ...
                    <div className="bg-blue-50 rounded-2xl p-8 md:p-12">
                        ...
                        <div className="text-gray-700 text-left leading-relaxed max-w-3xl mx-auto space-y-4">
                            <p>
                                O Google I/O Extended Belo Horizonte 2026 reunirá a comunidade em um grande encontro de tecnologia, inovação e troca de experiências na PUC Minas – Coração Eucarístico.
                            </p>
                            <p>
                                Fique ligado para mais novidades sobre os palestrantes e conteúdos que serão apresentados nesta edição!
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <section className="flex flex-col xl:flex-row items-center py-24 xl:p-32 justify-center gap-12 bg-gradient-to-r from-[#EBF3FC] via-[#EAF7F4] to-[#E9F9EF]">
                <div className="flex flex-col gap-6">
                    ...
                    <EventInformationCard icon={Clock}>08:00 às 12:30</EventInformationCard>
                </div>
