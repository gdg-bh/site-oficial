...
export function GoogleIO2026HeroCard() {
    return (
        <div className="mt-8 bg-white rounded-2xl drop-shadow-title px-6 py-6 md:px-10 md:py-8 flex flex-col items-center gap-4 max-w-3xl z-[1] w-full md:w-auto mx-4 md:mx-0">
            <h3 className="text-google-blue text-xl font-bold mb-2">Google I/O Extended 2026</h3>
            ...
            <a
                href="https://www.sympla.com.br/evento/google-io-extended-belo-horizonte/3429354"
                target="_blank"
                rel="noreferrer"
