...
export default function AboutGoogleIO2024() {
    return (
        <>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto mb-16">
                        <div className="bg-white rounded-2xl shadow-md p-8 hover:shadow-lg transition-shadow duration-300 flex flex-col items-center">
                            ...
                            <h3 className="text-4xl font-semibold text-google-blue mb-2">190</h3>
                    ...
                    <div className="bg-blue-50 rounded-2xl p-8 md:p-12">
                        ...
                        <div className="text-gray-700 text-left leading-relaxed max-w-3xl mx-auto space-y-4">
                            <p>
                                O Google I/O Extended Belo Horizonte 2024 reuniu a comunidade para uma manhã repleta de inovação, tecnologia e aprendizados de ponta. O encontro aconteceu na Localiza Labs, recebendo 190 participantes em um ambiente vibrante e colaborativo.
                            </p>

                            <p>
                                A programação contou com a presença de <strong>Mikaeri Ohana</strong>, mestranda na Unicamp, primeira mulher do Brasil reconhecida como Microsoft MVP em IA e também Google Developer Expert em ML. Mikaeri apresentou em detalhes as novidades do Google I/O sob a perspectiva da IA — incluindo Gemini, Gemma, modelos open-source e novas features de segurança. Sua talk trouxe ainda demonstrações práticas, mostrando como implementar essas capacidades em aplicações reais de forma simples, performática e com alto valor agregado.
                            </p>

                            <p>
                                Também tivemos <strong>Luís Leão</strong>, desenvolvedor evangelista na Twilio e GDE em Firebase, que trouxe uma visão abrangente sobre como a IA Generativa e o Firebase estão redefinindo o desenvolvimento de aplicações. Com sua experiência em APIs, educação e projetos de IoT para empresas como Google, Vivo e Fiat, Leão compartilhou insights valiosos sobre as principais atualizações anunciadas no Google I/O 2024.
                            </p>

                            <p>
                                Foi um evento marcante para a comunidade, fortalecendo conexões e inspirando novas ideias sobre o futuro da tecnologia. Uma excelente oportunidade para a comunidade local se atualizar sobre o ecossistema Google e descobrir novas ferramentas e recursos que podem impulsionar seus projetos de desenvolvimento.
                            </p>
                        </div>
                        <div className="flex justify-center mt-8">
                            <a
                                href="https://drive.google.com/drive/folders/1WEormfv-zb0OCJJ04406BMCCW9L2Tudz?usp=sharing"
                                target="_blank"
            ...
            <section className="flex flex-col xl:flex-row items-center py-24 xl:p-32 justify-center gap-12 bg-gradient-to-r from-[#EBF3FC] via-[#EAF7F4] to-[#E9F9EF]">
                <div className="flex flex-col gap-6">
                    <EventInformationCard icon={Calendar}>
                        Localiza Labs <br />
                        Rua Gurupá, 33 - Cachoeirinha
                    </EventInformationCard>
                    <EventInformationCard icon={MapPin}>
                        08 de junho de 2024
                    </EventInformationCard>
                    <EventInformationCard icon={Clock}>8:00 às 12:00</EventInformationCard>
                </div>
