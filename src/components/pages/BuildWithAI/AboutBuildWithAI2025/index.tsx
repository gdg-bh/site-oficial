        ...
        <>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto mb-16">
                        ...
                        <div className="bg-white rounded-2xl shadow-md p-8 hover:shadow-lg transition-shadow duration-300 flex flex-col items-center">
                            ...
                            <h3 className="text-4xl font-semibold text-google-blue mb-2">TBA</h3>
                    ...
                    <div className="bg-blue-50 rounded-2xl p-8 md:p-12">
                        ...
                        <div className="text-gray-700 text-left leading-relaxed max-w-3xl mx-auto space-y-4">
                            <p>
                                O Build With AI 2025 está chegando com tudo! Prepare-se para uma imersão ainda maior no universo da Inteligência Artificial Generativa e tecnologias Google.
                            </p>

                            <p>
                                Nesta edição, continuaremos nossa missão de capacitar a comunidade com workshops práticos, palestras técnicas e muito networking. Fique ligado para mais novidades sobre a programação, palestrantes e datas!
                            </p>

                            <p>
                                Com uma programação voltada a participantes de nível iniciante a intermediário, o Build With AI BH proporcionará aprendizado prático, troca de experiências e oportunidades de networking, fortalecendo a comunidade local e incentivando o uso de tecnologias atuais para criação de projetos inovadores.
                            </p>
                        </div>
                        {/* Comentado até termos fotos do evento
            ...
            <section className="flex flex-col xl:flex-row items-center py-24 xl:p-32 justify-center gap-12 bg-gradient-to-r from-[#EBF3FC] via-[#EAF7F4] to-[#E9F9EF]">
                <div className="flex flex-col gap-6">
                    ...
                    <EventInformationCard icon={Clock}>Horário a definir</EventInformationCard>
                </div>
                {/* Mapa comentado até termos o local definido
