...
export default function AboutBuildWithAI2026() {
    return (
        <>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto mb-16">
                        <div className="bg-white rounded-2xl shadow-md p-8 hover:shadow-lg transition-shadow duration-300 flex flex-col items-center">
                            ...
                            <h3 className="text-4xl font-semibold text-google-blue mb-2">50+</h3>
                            <p className="text-gray-600 text-base font-medium">Vagas</p>
                        </div>
                        ...
                        <div className="bg-white rounded-2xl shadow-md p-8 hover:shadow-lg transition-shadow duration-300 flex flex-col items-center">
                            ...
                            <h3 className="text-4xl font-semibold text-google-blue mb-2">1</h3>
                            <p className="text-gray-600 text-base font-medium">Palestrante</p>
                        </div>
                        ...
                        <div className="bg-white rounded-2xl shadow-md p-8 hover:shadow-lg transition-shadow duration-300 flex flex-col items-center">
                            ...
                            <h3 className="text-4xl font-semibold text-google-blue mb-2">3.5</h3>
                    ...
                    <div className="bg-blue-50 rounded-2xl p-8 md:p-12">
                        ...
                        <div className="text-gray-700 text-left leading-relaxed max-w-3xl mx-auto space-y-4">
                            <p>
                                O Build With AI 2026 será dedicado ao aprendizado e à aplicação prática de Inteligência Artificial Generativa utilizando as mais recentes tecnologias do Google. O evento reunirá desenvolvedores em um ambiente colaborativo voltado ao compartilhamento de conhecimento.
                            </p>
                            
                            <p>
                                Nesta edição, contaremos com a presença de Gabriel Cassimiro, que compartilhará conhecimentos técnicos, exemplos práticos e insights sobre como construir soluções inovadoras com Inteligência Artificial Generativa de ponta a ponta.
                            </p>
                             
                            <p>
                                O Build With AI BH 2026 proporcionará aprendizado prático, troca de experiências e oportunidades de networking, fortalecendo a comunidade local e incentivando o uso de tecnologias atuais para criação de projetos inovadores com IA!
                            </p>
                        </div>
                    </div>
                </div>
