...
import { duplicatedImages2024, duplicatedUrls2024 } from '../../../Common/SponsorURLs2024';

export default function SponsorsBuildWithAI2024() {
    ...
    return (
        <>
            <section className="bg-[#F7F9FB] py-20 overflow-hidden">
                ...
                <ContinuousSlider>
                    {duplicatedImages2024.map((src, idx) => (
                        <a
                            key={idx}
                            href={duplicatedUrls2024[idx]}
                            target="_blank"
