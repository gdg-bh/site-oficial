                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="bg-blue-50 rounded-2xl p-8 md:p-12">
                        ...
                        <div className="text-gray-700 text-left leading-relaxed max-w-3xl mx-auto space-y-4">
                            <p>
                                O Build With AI Belo Horizonte foi dedicado ao aprendizado e à aplicação prática de Inteligência Artificial Generativa utilizando o Gemini, a tecnologia de IA do Google. Realizado em dois dias, o evento reuniu desenvolvedores, entusiastas e profissionais da área para uma imersão técnica em ambientes colaborativos e orientados à prática.
                            </p>
                            
                            <p>
                                No dia 20 de abril, o foco foi Python, com um workshop conduzido por Gabriel Cassimiro, Google Developer Expert (GDE) em Machine Learning. Gabriel compartilhou sua experiência como Tech Lead em iniciativas de GenAI, apresentando conceitos, ferramentas e exemplos práticos para quem já possuía conhecimento prévio em Python.
                            </p>
                            
                            <p>
                                Já no dia 27 de abril, o destaque foi Flutter, com um workshop ministrado por Gabul, Google Developer Expert (GDE) em Flutter. Ele demonstrou como integrar Flutter a soluções de Inteligência Artificial, oferecendo insights valiosos sobre o desenvolvimento de aplicações modernas que fazem uso de IA generativa.
                            </p>
                            
                            <p>
                                Com uma programação voltada a participantes de nível iniciante a intermediário, o Build With AI BH proporcionou aprendizado prático, troca de experiências e oportunidades de networking, fortalecendo a comunidade local e incentivando o uso de tecnologias atuais para criação de projetos inovadores.
                            </p>
                        </div>
                        <div className="flex justify-center mt-8">
                            <a
                                href="https://drive.google.com/drive/u/2/folders/1Ca61mF6PRAM8ULBMo2HJ17HVa426xAJE"
                                target="_blank"
