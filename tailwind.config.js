    ...
    theme: {
        extend: {
            ...
            backgroundImage: {
                ...
                'gradient-text':
                    'linear-gradient(90deg, #3B86F0 4.84%, #2FA3AB 52.43%, #26B978 100%)',
                'gradient-session-light':
                    'linear-gradient(90deg, rgba(235, 243, 252, 0.9) 0%, rgba(234, 247, 244, 0.9) 69.23%, rgba(233, 249, 239, 0.9) 97.12%)',
                'gradient-session':
                    'linear-gradient(90deg, rgba(59, 135, 238, 0.9) 0%, rgba(47, 161, 174, 0.9) 69.23%, rgba(34, 194, 97, 0.9) 97.12%)',
            },
